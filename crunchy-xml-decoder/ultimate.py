...
def playerRev (url):
	...
	try:
		...
		try:
			...
			player_revision = '20151116135345.df81671a3d8a5f0ddd50b98d4c6374ca' 
...
cmd = '.\\video-engine\\rtmpdump -r "'+url1+'" -a "'+url2+'" -f "WIN 11,8,800,50" -m 15 -W "http://static.ak.crunchyroll.com/swf/ChromelessPlayerApp.swf" -p "'+page_url+'" -y "'+file+'" -o "'+title+'.flv"'
os.system(cmd)
